package com.crud.crudSBAMDB.global.exceptions;

import com.crud.crudSBAMDB.global.dto.MessageDto;
import com.crud.crudSBAMDB.global.utils.Operations;
...
public class GlobalException {
    ...
    public ResponseEntity<MessageDto> validationException(MethodArgumentNotValidException e){
        ...
        return ResponseEntity.badRequest().body(new MessageDto(HttpStatus.BAD_REQUEST, Operations.corchetes(messages.toString())));
    }
}
